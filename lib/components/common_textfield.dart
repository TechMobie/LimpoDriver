...
class _CommonTextfieldState extends State<CommonTextfield> {
  ...
  Widget build(BuildContext context) {
    return TextFormField(
      ...
      inputFormatters: (widget.textOption!.formatter.isNotEmpty)
          ? widget.textOption!.formatter
      ...
      style: const TextStyle().normal16.textColor(ColorSchema.black2Color),
      ...
      decoration: InputDecoration(
        ...
        labelStyle: (widget.textOption!.labelStyleText != null)
            ...
            : const TextStyle().medium20.textColor(ColorSchema.black2Color),
        filled: widget.textOption!.fill,
        fillColor: widget.textOption!.fillColor,
        contentPadding: widget.contentPadding ??
            EdgeInsets.symmetric(horizontal: getSize(10), vertical: 0),
